...
.EXAMPLE
.tools/EncodingChange.ps1 -InitialDirectory '$HOME\OneDrive\Git\SQL'
.tools/EncodingChange.ps1 -Filter '*.sql' -InitialDirectory '$HOME\OneDrive\Git\SQL'
.tools/EncodingChange.ps1 -SourceEncoding 'windows-1250' -InitialDirectory '$HOME\OneDrive\Git\SQL'
.tools/EncodingChange.ps1 -SourceEncoding 'utf8' -DestinationEncoding 'utf8BOM' -Filter ''*.sql -InitialDirectory '$HOME\OneDrive\Git\SQL\'
#>

param (
    $SourceEncoding,
    $DestinationEncoding = 'utf8',
    $FolderExclude = '\\\.git\\|\\\.venv\\|\\cache\\|\\bin\\|\\obj\\', # RegEx excluding directories starting with . and including cache
    $FileFilter = '*',
